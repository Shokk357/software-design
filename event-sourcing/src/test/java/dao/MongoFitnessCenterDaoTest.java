...
public class MongoFitnessCenterDaoTest {
    ...
    public void renewSubscription() {
        LocalDateTime now = fromString("2020-03-15 12:30");
        ...
        Subscription actualSubscription = dao.getLastVersionSubscription(0).toBlocking().single();
    ...
    public void renewNonExistingSubscription() {
        LocalDateTime now = fromString("2020-03-15 12:30");
        LocalDateTime later = now.plusMinutes(40);
        assertThat(dao
                ...
                .isEqualTo("Subscription 0 doesn't exist");
    }
    ...
    public void addEventToExpiredSubscription() {
        ...
        assertThat(dao
                ...
                .isEqualTo("Subscription duration had expired");
    }
}
